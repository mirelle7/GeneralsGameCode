    ...
    for line in diff_output.splitlines():
        if line.startswith("diff --git"):
            ...
            if added_line and not added_line.startswith("//") and not added_line.startswith("/*") and added_line not in ("{", "}", ");", ")", "#pragma once"):
                ...
                is_splitscreen_file = any(sf in current_file for sf in ["Seat", "Probe", "PatchNotes", "InGameUI", "ControlBar", "MessageStream", "CommandXlat", "MetaEvent", "SelectionXlat", "LookAtXlat", "Radar", "HeightMap", "W3DScene", "W3DShroud", "W3DView", "W3DTree", "W3DProp", "W3DParticle", "W3DTerrainTracks", "W3DBib", "SDL3Cursor", "SDL3Input", "Display", "GameClient", "GameEngine", "GlobalData", "GameInfo", "Diplomacy", "GhostObject", "Object", "PartitionManager", "ScriptActions", "VictoryConditions", "AnimateWindowManager", "GameWindowManager", "Shadow", "W3DDisplay", "W3DInGameUI", "W3DGhostObject", "ww3d", "triplets", "vcpkg", "config-build", "sdl3.cmake", "stb.cmake", "CMakeLists.txt", "CMakePresets.json", "scripts/verify_sync.py"])
